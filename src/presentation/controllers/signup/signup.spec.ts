...
import { ServerError, MissingParamError, InvalidPasswordError, InvalidParamError } from '../../erros'
...
describe('SignUp Controller', () => {
  ...
  test('Should return 400 if passwords differ from each other', async () => {
    const { sut } = makeSut()
    const httpRequest = {
      body: {
        name: 'any_name',
